...
execute if score bow gameSettings matches 5 run give @s crossbow[unbreakable={},enchantments={"minecraft:quick_charge":5,"minecraft:multishot":1}] 1
execute if score bow gameSettings matches 6 run give @s trident[unbreakable={},enchantments={"minecraft:impaling":2,"minecraft:loyalty":3}] 7
execute if score bow gameSettings matches 1..5 run give @s spectral_arrow 64
execute if score bow gameSettings matches 1..5 if score ammoSurplus gameSettings matches 1 run give @s spectral_arrow 192
